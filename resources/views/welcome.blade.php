...
@section('content')
    ...
    <section class="flex justify-around flex-col lg:flex-row items-center w-full py-20 container">
        <a href="/lojas">
            <img src="/imgs/brazil.png" alt="Mapa do brazil com pontos em que a loja esta carregada."
    ...
    <section class="flex items-center justify-center container flex-col">
        ...
        <div class="flex items-center flex-col lg:flex-row justify-between gap-8">
            <div class="flex flex-col ">
                <div
                    class="lg:max-w-[600px]  flex items-center rounded-3xl border-1 border-[#9e9e9e] my-2 text-lg font-semibold">
                    <p class="p-3">
            ...
            <img src="/imgs/AboutUsImage.png" alt="Imagem da norte auto peças, foto de frente da loja." />
        </div>
    </section>
    {{-- seção MVV --}}
    @php
        $Cards = [
            [
                ...
                'title' => 'Missão',
                'texto' =>
                    'Na Norte Auto Peças, estamos comprometidos em ser a principal fonte de peças para linha pesada, oferecendo qualidade inigualável e atendimento excepcional para impulsionar a confiança e o desempenho dos nossos clientes.',
            ...
            [
                ...
                'title' => 'Visão',
                'texto' =>
                    'Nossa visão é ser reconhecida como a referência global em peças para linha pesada, elevando constantemente os padrões da indústria por meio de inovação contínua e parcerias sólidas, mantendo nossa posição como líderes do mercado.',
            ...
            [
                ...
                'title' => 'Valores',
                'texto' =>
                    'Nossos valores fundamentais são qualidade intransigente, conhecimento especializado, parcerias confiáveis e compromisso inabalável com nossos clientes e colaboradores, sustentando nosso papel como a escolha preferencial no mercado de peças para linha pesada.',
                'imagem' => '/imgs/mvv/Icon-Valores.png',
            ],
        ];
    @endphp

    <div class="relative w-full lg:h-[600px] bg-cover bg-center h-[1000px]"
                ...
                <div key={{ $card['id'] }}
                    ...
                    <div class="max-w-60 absolute">
                        <div class="relative -bottom-24 left-[3.2rem] lg:-bottom-14 lg:left-[9.2rem]">
                            <img src="{{ $card['imagem'] }}" alt="{{ $card['title'] }}" class="mix-blend-multiply" />
                        </div>
                    </div>
                </div>
            @endforeach
